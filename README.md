...
This repository contains assignments, code, and supporting materials for the ANA 680: Machine Learning Deployment course at National University.
...
- **Assignment 3:** Three-Layer ANN Classifier for Bank Churn Prediction  
  ...
  - Goal: Predict whether a bank customer will churn using a three-layer ANN
  - Includes preprocessing (encoding, scaling), model training, evaluation, and feature significance analysis.
